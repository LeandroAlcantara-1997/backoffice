...
func (_mock *CacheMock) Set(ctx context.Context, key string, payload any, duration time.Duration) error {
	ret := _mock.Called(ctx, key, payload, duration)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, any, time.Duration) error); ok {
		r0 = returnFunc(ctx, key, payload, duration)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_e *CacheMock_Expecter) Set(ctx interface{}, key interface{}, payload interface{}, duration interface{}) *CacheMock_Set_Call {
	return &CacheMock_Set_Call{Call: _e.mock.On("Set", ctx, key, payload, duration)}
}

func (_c *CacheMock_Set_Call) Run(run func(ctx context.Context, key string, payload any, duration time.Duration)) *CacheMock_Set_Call {
...
func (_c *CacheMock_Set_Call) RunAndReturn(run func(ctx context.Context, key string, payload any, duration time.Duration) error) *CacheMock_Set_Call {
	_c.Call.Return(run)
	return _c
}
